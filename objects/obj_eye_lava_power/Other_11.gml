...
{
instance_create_layer(x + sprite_width, y, "Instances", obj_eye_lava);
	...
	var bullet = instance_create_layer(x + x_offset, y + y_offset, "Instances", obj_bullet_enemy_lava_powered_up);
