if not instance_exists(obj_eye_earth_power) exit;
var hp_x = 8
var hp_y = 300
var hp_width = 198
var hp_height = 6
if instance_exists(obj_eye_earth_power)
{
draw_health_ = lerp(draw_health_, obj_eye_earth_power.health_, 0.2)
draw_max_health_ = obj_eye_earth_power.max_health_
} else {
	draw_health_ =lerp(draw_health_, 0, 0.2)
}
var hp_percentage = draw_health_ / draw_max_health_ / 15
