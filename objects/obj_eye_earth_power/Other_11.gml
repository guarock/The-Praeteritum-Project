...
{
instance_create_layer(x + sprite_width, y, "Instances", obj_eye_earth);
	...
	var bullet = instance_create_layer(x + x_offset, y + y_offset, "Instances", obj_bullet_enemy_earth_powered_up);
