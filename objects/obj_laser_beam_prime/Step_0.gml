...
for (i = 0; i < max_length; i++)
{
	...
	if (collision_point(xEnd, yEnd, obj_wall_in_game, 0, 0)) {
		...
		part_particles_create(obj_particle.particle_system, xEnd, yEnd, obj_particle.particle_type_Hit_Prime, 1)
		part_particles_create(obj_particle.particle_system, xEnd, yEnd, obj_particle.particle_type_Spark_Prime, 15)
		break;
	}
}
...
var hits = collision_line_list(x, y, xEnd, yEnd, obj_eye_laser, 0, 0, _list, 0)
		...
		if (hits > 0)
		{
			...
			{
				_list[| k].health_ =  _list[| k].health_ -2
					break;
