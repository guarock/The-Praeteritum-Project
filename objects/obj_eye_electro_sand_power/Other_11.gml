...
if alarm[0] <= 0 && attack_ = true
{
	if health_ <= 350
{
instance_create_layer(x + sprite_width, y, "Instances", obj_bullet_hit_enemy_thunder_2);
instance_create_layer(x + sprite_width, y, "Instances", obj_bullet_hit_enemy_thunder_2);
instance_create_layer(x + sprite_width, y, "Instances", obj_bullet_hit_enemy_thunder_2);
}
	...
	var bullet = instance_create_layer(x + x_offset, y + y_offset, "Instances", obj_bullet_enemy_electro_sand_powered_up);
